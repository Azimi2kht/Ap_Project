...
#include <memory>
#include "../../../Catan-Server/channels.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_channels_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_channels_t qt_meta_stringdata_channels = {
    {
QT_MOC_LITERAL(0, 8) // "channels"
...
const QMetaObject channels::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_channels.offsetsAndSize,
    qt_meta_data_channels,
    qt_static_metacall,
    nullptr,
    nullptr,
    nullptr
